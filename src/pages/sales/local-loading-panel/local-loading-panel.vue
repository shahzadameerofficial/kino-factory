<template>
    <div class="row main" @submit.prevent="beginLoading()" ref="localLoading">
        <div class="col-12 mb-2">
            <div class="kino-title rounded-pill">
                <h6 class="mb-0">Local Loading Panel</h6>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-2">
                    <div class="kino-selector">
                        ...
                        <DisplayField :data="loading.supervisorId" :display="['name', 'mobile']" />
                    </div>
                </div>
            </div>
        </div>
